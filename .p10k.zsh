# Generated by Powerlevel10k configuration wizard on 2020-11-12 at 12:34 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%240F╰─%140F '
  ...
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    ...
    '*'                    DEFAULT    '\uf07c')
  # Styling for WORK_NOT_WRITABLE.
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_FOREGROUND=009
