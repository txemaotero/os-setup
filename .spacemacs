...
you should place you code here."
  ...
  ;; Alterar Alt derecho para que funcione la ñ
...
;; Pymacs not work
;; (load-file "~/github/pymacs/src/pymacs/pymacs.el")
;; (require 'pymacs)
